...
feature='conch'
device=0
dataset_csv='/home/yuhaowang/project/WSIFew/cca_mil/dataset_csv/camelyon.csv'
feature_dir='/data/yuhaowang/WSIFew/processd_wsi/CAMELYON/feature/pt_files'
concept_bank='text_prompt/concept_bank/camelyon.json'
